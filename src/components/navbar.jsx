            ...
            {user ? (
               <div className="relative flex items-center gap-3 group">
                ...
                <div className="absolute right-0 top-8 w-44 bg-white shadow-lg border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                  <Link
                    to="/profile"
                    className="flex items-center gap-2 px-4 py-3 text-xs text-gray-600 hover:bg-gray-50 hover:text-[#1a1410] no-underline transition-colors"
                  >
                  ...
                  <button
                    onClick={logout}
                    className="flex items-center gap-2 px-4 py-3 text-xs text-red-400 hover:bg-red-50 hover:text-red-600 w-full bg-transparent border-none cursor-pointer transition-colors"
                  >
              ...
              <button
                ...
                className=" text-white-400  transition-colors  border-none cursor-pointer bg-[#C8A03C] hover:bg-[#e0b84a] text-black text-[13px] text-bold  px-3 py-1 rounded tracking-[1px] uppercase"
              >
